...
## 🚀 심화 분석 프로젝트 (Advanced Projects - 2025년 12월)
...
* **주요 내용**:
    ...
    * 결측치 처리 및 특성 공학
    * 다양한 분류 모델 구현 및 비교 (Logistic Regression, Random Forest, Gradient Boosting 등)
    * 모델 앙상블 기법 적용
...
청주시의 버스 운행 데이터를 분석하여 비정상적인 패턴을 탐지하는 프로젝트입니다
...
* **주요 내용**:
    ...
    * 시계열 데이터 전처리 및 정규화
    * 이상 탐지 알고리즘 구현 (Isolation Forest, LOF, Autoencoder)
    * 실시간 모니터링 시스템 구축
...
* **주요 내용**:
    ...
    * 머신러닝 기반 방법 (Isolation Forest, LOF, One-Class SVM)
    * 딥러닝 기반 방법 (Autoencoder, LSTM-Autoencoder)
    * 알고리즘별 성능 비교 및 하이퍼파라미터 최적화
...
### 머신러닝 & 딥러닝
* ✅ 지도학습 (분류, 회귀) / 비지도학습 (클러스터링, 이상탐지)
* ✅ 신경망 아키텍처 설계 (CNN, RNN, LSTM 구현)
* ✅ 최적화 기법 및 하이퍼파라미터 튜닝

### 이상 탐지 및 시계열 분석
* ✅ 통계 및 머신러닝 기반 이상탐지 (IF, LOF, SVM)
* ✅ 딥러닝 기반 이상탐지 (Autoencoder)
* ✅ 시계열 전처리 및 패턴 분석, 예측 모델링

### 실무 기술
* ✅ 프론트엔드 업무 자동화 (Vanilla JS 기반 DOM 제어)
* ✅ 웹 프레임워크 (Flask) 및 공공 API 활용
* ✅ 버전 관리 (Git/GitHub)
