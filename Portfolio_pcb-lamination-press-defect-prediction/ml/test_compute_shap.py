...
try:
    dataset = SyntheticPressDataset(n_cycles=32, n_points=64, anomaly_prob=0.15, seed=42)
    ...
    # call compute_and_save_shap
    res = compute_and_save_shap(model, loader, output_dir, method='shap', subsample=8, baseline='mean', device=str(device))
